      ...
      <div className="container">
        <div className="row">
          <div className="col-sm-12 text-center">
            ...
            <a className="btn btn-social-icon btn-instagram social-logo" href="https://www.instagram.com/10psaltlakecity/" target="_blank" rel="noopener noreferrer"><i
              className="fa fa-instagram instalogo"></i></a>

            <a className="btn btn-social-icon btn-facebook social-logo" href="https://www.facebook.com/10thPlanetSLC/" target="_blank" rel="noopener noreferrer"><i
